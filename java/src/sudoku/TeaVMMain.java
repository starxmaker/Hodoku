 ...
 */
@JSExportClasses({TeaVMStdout.class, TeaVMRatingStream.class, TeaVMSolutionPathStream.class, TeaVMRater.class, TeaVMGenerationStream.class, TeaVMGenerator.class})

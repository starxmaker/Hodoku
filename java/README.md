...
Fork of Hodoku that removes UI functionality and transpiles the code into JavaScript (via TeaVM), and add additional QoL features for easy JS integration.
